...
form.addEventListener('submit', (event) => {
  ...
  let etat = '';
  if (temperature >= 38 && (toux || fatigue || maux || respiratoire === 'grande' || malade === 'Oui' || voyage === 'Oui')) {
    etat = 'Risque élevé. Il est recommandé de contacter un professionnel de santé.';
  } else if (temperature >= 38 || (toux && (fatigue || maux)) || respiratoire === 'moyenne' || malade === 'Non' || voyage === 'Non') {
